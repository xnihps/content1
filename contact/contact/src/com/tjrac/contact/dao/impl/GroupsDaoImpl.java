...
public class GroupsDaoImpl implements IGroupsDao {
	...
	@Override
	public ResultSet SelectAllGroupByGname(String gname, String username,Connection connection) throws Exception {
		// TODO Auto-generated method stub
		SQLManager sqlManager = new SQLManager();
		String strSQL = "select * from groups where gname=? and username=?";
		Object[] params = new Object[] { gname,username };
		ResultSet rs = sqlManager.execQuery(connection,strSQL,params);
		return rs;
	}
