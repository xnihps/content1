...
%>
	<a href="CancelloginServlet">注销账号</a>&nbsp;&nbsp;&nbsp;&nbsp;
	<a href="updataPwd.jsp">修改密码</a>
	<c:if test="${empty requestScope.groupList }">
		<script >alert("没有分组，请添加")</script>
	</c:if>
	<h3>分组管理&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="addGroup.jsp">添加分组</a></h3>
	<form action="FuzzySearchServlet" method="get" align = "center">
			查询联系人或分组<input type="text" name="temp" value=""/>
